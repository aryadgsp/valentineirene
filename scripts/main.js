; (function(window) {
  ...
  let texts = ['Irene', 'with you', 'feels like', 'a', 'beautiful', 'dream', 'come true', 'so grateful', 'to have you', 'Love U Most']
  ...
  function setDimensions() {
    ...
    canvas.style.transform = window.innerWidth > 768 
        ? 'translate(-5%, -5%)'  // Jika desktop
        : 'translate(-0%, -0%)'; // Jika mobile
  }
